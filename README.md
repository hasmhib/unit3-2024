...
| 6       | Development of DatabaseBridge and other functions          | Implement class DatabaseBridge for this project and create functions for hashing and verification.                                                               | 2 hours       | Feb 24                 | B,C       |
...
| 8       | Implement login functionality                              | Develop the logic for user authentication, including password hashing.                                                                                           | 4 hours       | Feb 27                 | C         |
...
| 10      | I broke left middle finger                                 | -                                                                                                                                                                | -             | Mar 1                  | -         |
| 11      | Implement forgot password and reset functionalities        | Create user interfaces and functions for password resetting, including security questions and email verification steps.                                          | 3 hours       | Mar 3                  | C         |
| 12      | Develop the main menu and navigation system                | Implement the main menu GUI, enabling navigation between different sections of the application (ex. Finance, Orders, and inventory).                             | 1 hour        | Mar 3                  | C         |
| 13      | Financial data visualization feature development           | Develop the finances screen, developing data visualization elements (pie charts and bar graphs) to represent finances and customer pillow material distribution. | 5 hours       | Mar 3                  | C         |
| 14      | Follow up meeting with client                              | Showing the application to the client and asking for their opinion on the application's current progress.                                                        | 30 min        | Mar 3                  | A         |
| 15      | Customer information and order management system           | Create a code to manage customer information and orders, including GUIs for data entry and display using tables.                                                 | 2 hour        | Mar 4                  | C         |
| 16      | Inventory management system development                    | Implement inventory tracking and management features, with the order processing system by adding and subtracting materials.                                      | 5 hours       | Mar 4                  | C         |
| 17      | Enhance application security                               | Include password encryption and registration.                                                                                                                    | 2 hour        | Mar 4                  | C         |
| 18      | Optimize application performance                           | Double-check all functions and debug if any bug is found.                                                                                                        | 1 hour        | Mar 4                  | C         |
| 19      | Conduct final testing and client review                    | Flow diagrams for the different codes, and some brief explanations.                                                                                              | 1 hour        | Mar 6                  | C         |
| 20      | Gather client's feedback                                   | Collect feedback from clients, and prioritize features and fixes small issues.                                                                                   | 1 hour        | Mar 6                  | C         |
| 21      | Create UML Diagram and write a brief description           | Have a clear UML Diagram that accurately shows the different classes and methods used with a brief explanation.                                                  | 30 min        | Mar 8                  | B         |
| 22      | Write the test plans                                       | Processes one by one and take to test the program and the expected outcome of each test is recorded.                                                             | 1 hour        | Mar 8                  | B         |
| 23      | Create flow diagrams and write brief explanations for each | Have accurate flow diagrams for different parts of the porogram with brief explanations.                                                                         | 1 hour        | Mar 9                  | B         |
| 24      | Finish Criteria C                                          | Write the descriptions of the code and the details of the techniques that were used.                                                                             | 4 hours       | Mar 10                 | C         |
| 25      | Finish video for Criteria D                                | Video evidence of all the success criterias functioning and working within the developed applicaiton.                                                            | 30 min        | Mar 10                 | D         |
